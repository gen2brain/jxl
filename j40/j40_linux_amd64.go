// Code generated by 'ccgo -pkgname j40 -ignore-unsupported-alignment -export-externs "" -export-defines "" -export-fields "" -export-structs "" -export-typedefs "" -o j40.go j40.c', DO NOT EDIT.
...
const (
	...
	J40__CLANG_VER                       = 0                      // j40.h:333:2:
	J40__COEFFS_ALIGN                    = 64                     // j40.h:6242:2:
	J40__ERRBUF_LEN                      = 256                    // j40.h:7894:2:
	J40__EXPOSE_INTERNALS                = 0                      // j40.h:104:3:
	J40__GCC_VER                         = 786944                 // j40.h:325:2:
	J40__INITIAL_BUFSIZE                 = 0x10000                // j40.h:1613:1:
	J40__MAX_DIST_MULT                   = 2097152                // j40.h:2459:1:
	J40__PIXELS_ALIGN                    = 32                     // j40.h:976:1:
	J40__RECURSING                       = 9999                   // j40.h:8344:1:
	J40__SQRT2                           = 1.4142135623730951     // j40.h:5614:1:
...
const ( /* j40.h:7841:1: */ // each API defines its origin value; they don't have to be stable
	J40__ORIGIN_NONE           = 0
...
func X__clzmy(tls *libc.TLS, x uint32) int32 { /* j40.h:280:5: */
...
// appended at the *top* of the bit buffer. when the logical buffer has been exhausted
// higher layers (first backing buffer, then container, and finally source) should be consulted.
type J40__bits_st = J40__bits_st1 /* j40.h:436:3 */
...
func j40__set_error(tls *libc.TLS, st uintptr, err J40_err) J40_err { /* j40.h:513:20: */
...
func j40__malloc(tls *libc.TLS, size Size_t) uintptr { /* j40.h:519:17: */
	return libc.Xmalloc(tls, size)
}

func j40__calloc(tls *libc.TLS, num Size_t, size Size_t) uintptr { /* j40.h:520:17: */
	return libc.Xcalloc(tls, num, size)
}

func j40__realloc32(tls *libc.TLS, st uintptr, ptr uintptr, itemsize Size_t, len Int32_t, cap uintptr) uintptr { /* j40.h:522:17: */
	var newptr uintptr
	var newcap Uint32_t
	var newsize Size_t
...
func j40__realloc64(tls *libc.TLS, st uintptr, ptr uintptr, itemsize Size_t, len Int64_t, cap uintptr) uintptr { /* j40.h:540:17: */
	var newptr uintptr
	var newcap Uint64_t
	var newsize Size_t
...
func j40__free(tls *libc.TLS, ptr uintptr) { /* j40.h:558:17: */
	libc.Xfree(tls, ptr)
}

func J40__unpack_signed(tls *libc.TLS, x Int32_t) Int32_t { /* j40.h:587:27: */
	return func() int32 {
		if x&1 != 0 {
			return -(x/2 + 1)
		}
...
func J40__unpack_signed64(tls *libc.TLS, x Int64_t) Int64_t { /* j40.h:590:27: */
	return func() int64 {
		if x&int64(1) != 0 {
...
func J40__ceil_div32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:595:27: */
	return (x + y - 1) / y
}

func J40__ceil_div64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:596:27: */
	return (x + y - int64(1)) / y
}

func J40__minf(tls *libc.TLS, x float32, y float32) float32 { /* j40.h:598:25: */
	return func() float32 {
		if x < y {
			return x
		}
...
func J40__maxf(tls *libc.TLS, x float32, y float32) float32 { /* j40.h:599:25: */
	return func() float32 {
		if x > y {
			return x
		}
...
//J40_ALWAYS_INLINE bool isXFinite(double f) { return !isnan(f - f); }

// used to guard against division by zero
func J40__surely_nonzero(tls *libc.TLS, x float32) int32 { /* j40.h:605:23: */
	//return isXFinite(x) && fabs(x) >= 1e-8f;
	return libc.Bool32(!(libc.X__builtin_isnan(tls, float64(x-x)) != 0) && libc.Xfabs(tls, float64(x)) >= 1e-8)
}

//J40_ALWAYS_INLINE int __clzmy(unsigned x);
...
func J40__floor_avg16(tls *libc.TLS, x Int16_t, y Int16_t) Int16_t { /* j40.h:669:29: */
	return Int16_t(int32(x)/2 + int32(y)/2 + int32(x)&int32(y)&1)
}

func J40__abs16(tls *libc.TLS, x Int16_t) Int16_t { /* j40.h:673:29: */
	return func() int16 {
		if int32(x) < 0 {
...
func J40__min16(tls *libc.TLS, x Int16_t, y Int16_t) Int16_t { /* j40.h:676:29: */
	return func() int16 {
		if int32(x) < int32(y) {
			return x
		}
...
func J40__max16(tls *libc.TLS, x Int16_t, y Int16_t) Int16_t { /* j40.h:679:29: */
	return func() int16 {
		if int32(x) > int32(y) {
			return x
		}
...
func J40__add16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:683:23: */
	...
	return J40__add_fallback16(tls, x, y, out)
}

func J40__sub16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:693:23: */
	//return !J40_SUB_OVERFLOW(x, y, out);
	return J40__sub_fallback16(tls, x, y, out)
}

func J40__mul16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:702:23: */
	//return !J40_MUL_OVERFLOW(x, y, out);
	return J40__mul_fallback16(tls, x, y, out)
}

func J40__add_fallback16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:711:23: */
...
func J40__sub_fallback16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:720:23: */
...
func J40__mul_fallback16(tls *libc.TLS, x Int16_t, y Int16_t, out uintptr) int32 { /* j40.h:729:23: */
...
func J40__clamp_add16(tls *libc.TLS, x Int16_t, y Int16_t) Int16_t { /* j40.h:742:29: */
	bp := tls.Alloc(2)
	defer tls.Free(2)
...
func J40__clamp_mul16(tls *libc.TLS, x Int16_t, y Int16_t) Int16_t { /* j40.h:747:29: */
	bp := tls.Alloc(2)
	defer tls.Free(2)
...
func J40__floor_lg16(tls *libc.TLS, x Uint16_t) int32 { /* j40.h:771:24: */
	return 16 - 1 - X__clzmy(tls, uint32(x))

}

func J40__ceil_lg16(tls *libc.TLS, x Uint16_t) int32 { /* j40.h:774:24: */
	if int32(x) > 1 {
		return 16 - X__clzmy(tls, uint32(int32(x)-1))
	}
	return 0
...
// same to `(a + b) >> 1` but doesn't overflow, useful for tight loops with autovectorization
// https://devblogs.microsoft.com/oldnewthing/20220207-00/?p=106223
func J40__floor_avg32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:669:29: */
	return x/2 + y/2 + x&y&1
}

func J40__abs32(tls *libc.TLS, x Int32_t) Int32_t { /* j40.h:673:29: */
	return func() int32 {
		if x < 0 {
			return -x
		}
...
func J40__min32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:676:29: */
	return func() int32 {
		if x < y {
			return x
		}
...
func J40__max32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:679:29: */
	return func() int32 {
		if x > y {
			return x
		}
...
func J40__add32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:683:23: */
	// gcc/clang extension uses an opposite convention, which is unnatural to use with J40__SHOULD
	//return !J40_ADD_OVERFLOW(x, y, out);
	return J40__add_fallback32(tls, x, y, out)
}

func J40__sub32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:693:23: */
	//return !J40_SUB_OVERFLOW(x, y, out);
	return J40__sub_fallback32(tls, x, y, out)
}

func J40__mul32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:702:23: */
	//return !J40_MUL_OVERFLOW(x, y, out);
	return J40__mul_fallback32(tls, x, y, out)
}

func J40__add_fallback32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:711:23: */
...
func J40__sub_fallback32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:720:23: */
...
func J40__mul_fallback32(tls *libc.TLS, x Int32_t, y Int32_t, out uintptr) int32 { /* j40.h:729:23: */
	if libc.X__builtin_expect(tls, libc.BoolInt64(!!(func() int32 {
		if x > 0 {
			return func() int32 {
				if y > 0 {
...
func J40__clamp_add32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:742:29: */
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
func J40__clamp_mul32(tls *libc.TLS, x Int32_t, y Int32_t) Int32_t { /* j40.h:747:29: */
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
// both requires x to be > 0
func J40__floor_lg32(tls *libc.TLS, x Uint32_t) int32 { /* j40.h:771:24: */
	return 32 - 1 - X__clzmy(tls, x)

}

func J40__ceil_lg32(tls *libc.TLS, x Uint32_t) int32 { /* j40.h:774:24: */
	if x > Uint32_t(1) {
		return 32 - X__clzmy(tls, x-Uint32_t(1))
	}
	return 0
...
// same to `(a + b) >> 1` but doesn't overflow, useful for tight loops with autovectorization
// https://devblogs.microsoft.com/oldnewthing/20220207-00/?p=106223
func J40__floor_avg64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:669:29: */
	return x/int64(2) + y/int64(2) + x&y&int64(1)
}

func J40__abs64(tls *libc.TLS, x Int64_t) Int64_t { /* j40.h:673:29: */
	return func() int64 {
		if x < int64(0) {
			return -x
		}
...
func J40__min64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:676:29: */
	return func() int64 {
		if x < y {
			return x
		}
...
func J40__max64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:679:29: */
	return func() int64 {
		if x > y {
			return x
		}
...
func J40__add64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:683:23: */
	// gcc/clang extension uses an opposite convention, which is unnatural to use with J40__SHOULD
	//return !J40_ADD_OVERFLOW(x, y, out);
	return J40__add_fallback64(tls, x, y, out)
}

func J40__sub64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:693:23: */
	//return !J40_SUB_OVERFLOW(x, y, out);
	return J40__sub_fallback64(tls, x, y, out)
}

func J40__mul64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:702:23: */
	//return !J40_MUL_OVERFLOW(x, y, out);
	return J40__mul_fallback64(tls, x, y, out)
}

func J40__add_fallback64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:711:23: */
...
func J40__sub_fallback64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:720:23: */
...
func J40__mul_fallback64(tls *libc.TLS, x Int64_t, y Int64_t, out uintptr) int32 { /* j40.h:729:23: */
	if libc.X__builtin_expect(tls, libc.BoolInt64(!!(func() int32 {
		if x > int64(0) {
			return func() int32 {
				if y > int64(0) {
...
func J40__clamp_add64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:742:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func J40__clamp_mul64(tls *libc.TLS, x Int64_t, y Int64_t) Int64_t { /* j40.h:747:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
// both requires x to be > 0
func J40__floor_lg64(tls *libc.TLS, x Uint64_t) int32 { /* j40.h:771:24: */
	return 64 - 1 - X__clzmy(tls, uint32(x))

}

func J40__ceil_lg64(tls *libc.TLS, x Uint64_t) int32 { /* j40.h:774:24: */
	if x > uint64(1) {
		return 64 - X__clzmy(tls, uint32(x-uint64(1)))
	}
	return 0
...
// }
// #else
func J40__alloc_aligned(tls *libc.TLS, sz Size_t, align Size_t, outmisalign uintptr) uintptr { /* j40.h:834:28: */
	return J40__alloc_aligned_fallback(tls, sz, align, outmisalign)

}

func J40__free_aligned(tls *libc.TLS, ptr uintptr, align Size_t, misalign Size_t) { /* j40.h:837:28: */
...
func J40__alloc_aligned_fallback(tls *libc.TLS, sz Size_t, align Size_t, outmisalign uintptr) uintptr { /* j40.h:845:34: */
...
func J40__free_aligned_fallback(tls *libc.TLS, ptr uintptr, align Size_t, misalign Size_t) { /* j40.h:859:41: */
	if !(ptr != 0) {
		return
	}
...
func J40__make_view_f32(tls *libc.TLS, logw Int32_t, logh Int32_t, ptr uintptr) J40__view_f32 { /* j40.h:883:33: */
	var ret = J40__view_f32{Logw: logw, Logh: logh, Ptr: ptr}
	return ret
}

func J40__adapt_view_f32(tls *libc.TLS, outv uintptr, logw Int32_t, logh Int32_t) { /* j40.h:888:24: */

	(*J40__view_f32)(unsafe.Pointer(outv)).Logw = logw
	(*J40__view_f32)(unsafe.Pointer(outv)).Logh = logh
}

func J40__reshape_view_f32(tls *libc.TLS, outv uintptr, logw Int32_t, logh Int32_t) { /* j40.h:894:24: */

	(*J40__view_f32)(unsafe.Pointer(outv)).Logw = logw
	(*J40__view_f32)(unsafe.Pointer(outv)).Logh = logh
}

func J40__copy_view_f32(tls *libc.TLS, outv uintptr, inv J40__view_f32) { /* j40.h:900:24: */
	var x Int32_t
	var y Int32_t
...
func J40__transpose_view_f32(tls *libc.TLS, outv uintptr, inv J40__view_f32) { /* j40.h:909:24: */
	var x Int32_t
	var y Int32_t
	var outptr uintptr = (*J40__view_f32)(unsafe.Pointer(outv)).Ptr
...
func J40__oddeven_columns_to_halves_f32(tls *libc.TLS, outv uintptr, inv J40__view_f32) { /* j40.h:919:24: */
	var x Int32_t
	var y Int32_t
	var outptr uintptr = (*J40__view_f32)(unsafe.Pointer(outv)).Ptr
...
func J40__oddeven_rows_to_halves_f32(tls *libc.TLS, outv uintptr, inv J40__view_f32) { /* j40.h:931:24: */
	var x Int32_t
	var y Int32_t
	var outptr uintptr = (*J40__view_f32)(unsafe.Pointer(outv)).Ptr
...
func J40__print_view_f32(tls *libc.TLS, v J40__view_f32, name uintptr, file uintptr, line Int32_t) { /* j40.h:950:34: */
	bp := tls.Alloc(72)
	defer tls.Free(72)
...
func j40__init_plane(tls *libc.TLS, st uintptr, type1 Uint8_t, width Int32_t, height Int32_t, flags uint32, out uintptr) J40_err { /* j40.h:1020:29: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
func j40__plane_all_equal_sized(tls *libc.TLS, begin uintptr, end uintptr) int32 { /* j40.h:1053:16: */
	var c J40__plane
...
func j40__plane_all_equal_typed(tls *libc.TLS, begin uintptr, end uintptr) Uint8_t { /* j40.h:1069:20: */
	var type1 Uint8_t
	if begin >= end {
		return Uint8_t(0)
	}
...
func j40__free_plane(tls *libc.TLS, plane uintptr) { /* j40.h:1079:17: */
...
type J40__limits = J40__limits1 /* j40.h:1108:3 */

var sJ40__MAIN_LV5_LIMITS = J40__limits{Pixels: int64(int32(1) << 28), Width: int32(1) << 18, Height: int32(1) << 18, Icc_output_size: uint64(uint32(1) << 22), Bpp: 16, Num_extra_channels: 4, Needs_modular_16bit_buffers: 1, Nb_transforms: 8, Nb_channels_tr: 256, Tree_depth: 64, Zf_pixels: int64(int32(1) << 28)} /* j40.h:1114:26 */
...
type J40_source_read_func = uintptr /* j40.h:1133:13 */
type J40_source_seek_func = uintptr /* j40.h:1134:13 */
type J40_source_free_func = uintptr /* j40.h:1135:14 */ // intentionally same to j40_memory_free_func

type J40__source_st = J40__source_st1 /* j40.h:1145:3 */

func j40__memory_source_read(tls *libc.TLS, buf uintptr, fileoff Int64_t, maxsize Size_t, size uintptr, data uintptr) int32 { /* j40.h:1160:16: */
...
func j40__init_memory_source(tls *libc.TLS, st uintptr, buf uintptr, size Size_t, freefunc J40_memory_free_func, source uintptr) J40_err { /* j40.h:1167:29: */
__1:
	if !(libc.X__builtin_expect(tls, libc.BoolInt64(!!(int32((*J40__st)(unsafe.Pointer(st)).Err) != 0)), int64(0)) != 0) {
		goto __4
	}
...
func j40__file_source_read(tls *libc.TLS, buf uintptr, fileoff Int64_t, maxsize Size_t, size uintptr, data uintptr) int32 { /* j40.h:1181:16: */
	var fp uintptr = data
	var read Size_t
...
func j40__file_source_seek(tls *libc.TLS, fileoff Int64_t, data uintptr) int32 { /* j40.h:1198:16: */
	var fp uintptr = data
	if fileoff < int64(0) {
		return 1
	}
...
func j40__file_source_free(tls *libc.TLS, data uintptr) { /* j40.h:1215:17: */
	var fp uintptr = data
	libc.Xfclose(tls, fp)
}

func j40__init_file_source(tls *libc.TLS, st uintptr, path uintptr, source uintptr) J40_err { /* j40.h:1220:29: */
	var fp uintptr
...
func j40__try_read_from_source(tls *libc.TLS, st uintptr, buf uintptr, minsize Int64_t, maxsize Int64_t, size uintptr) J40_err { /* j40.h:1247:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func j40__read_from_source(tls *libc.TLS, st uintptr, buf uintptr, size Int64_t) J40_err { /* j40.h:1288:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func j40__seek_from_source(tls *libc.TLS, st uintptr, fileoff Int64_t) J40_err { /* j40.h:1293:29: */
	var source uintptr
	var saved_errno int32
	source = (*J40__st)(unsafe.Pointer(st)).Source
...
func j40__free_source(tls *libc.TLS, source uintptr) { /* j40.h:1320:17: */
...
type J40__container_st = J40__container_st1 /* j40.h:1367:3 */

func J40__u32be(tls *libc.TLS, p uintptr) Uint32_t { /* j40.h:1378:28: */
...
func j40__box_header(tls *libc.TLS, st uintptr, type1 uintptr, size uintptr) J40_err { /* j40.h:1383:29: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
func j40__container(tls *libc.TLS, st uintptr, wanted_codeoff Int64_t) J40_err { /* j40.h:1418:29: */
	bp := tls.Alloc(48)
	defer tls.Free(48)
...
func j40__search_codestream_offset(tls *libc.TLS, st uintptr, codeoff Int64_t) Int32_t { /* j40.h:1546:20: */
...
func j40__map_codestream_offset(tls *libc.TLS, st uintptr, codeoff Int64_t, fileoff uintptr) J40_err { /* j40.h:1557:29: */
	var map1 uintptr
	var nmap Int32_t
	var i Int32_t
...
func j40__free_container(tls *libc.TLS, container uintptr) { /* j40.h:1583:17: */
...
type J40__buffer_st = J40__buffer_st1 /* j40.h:1602:3 */

func j40__init_buffer(tls *libc.TLS, st uintptr, codeoff Int64_t, codeoff_limit Int64_t) J40_err { /* j40.h:1615:29: */
	var bits uintptr
...
func j40__refill_buffer(tls *libc.TLS, st uintptr) J40_err { /* j40.h:1632:29: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
func j40__seek_buffer(tls *libc.TLS, st uintptr, codeoff Int64_t) J40_err { /* j40.h:1714:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func j40__codestream_offset(tls *libc.TLS, st uintptr) Int64_t { /* j40.h:1732:20: */
...
func J40__bits_read(tls *libc.TLS, st uintptr) Int64_t { /* j40.h:1738:37: */
...
func j40__free_buffer(tls *libc.TLS, buffer uintptr) { /* j40.h:1746:17: */
...
func j40__always_refill(tls *libc.TLS, st uintptr, n Int32_t) J40_err { /* j40.h:1786:29: */
	var bits uintptr
...
var NBITS Int32_t = 64 /* j40.h:1787:23 */

func j40__zero_pad_to_byte(tls *libc.TLS, st uintptr) J40_err { /* j40.h:1823:29: */
...
func j40__skip(tls *libc.TLS, st uintptr, n Int64_t) J40_err { /* j40.h:1831:29: */
...
func j40__u(tls *libc.TLS, st uintptr, n Int32_t) Int32_t { /* j40.h:1853:20: */
	var ret Int32_t
...
func j40__64u(tls *libc.TLS, st uintptr, n Int32_t) Int64_t { /* j40.h:1863:20: */
	var ret Int64_t
...
func j40__u32(tls *libc.TLS, st uintptr, o0 Int32_t, n0 Int32_t, o1 Int32_t, n1 Int32_t, o2 Int32_t, n2 Int32_t, o3 Int32_t, n3 Int32_t) Int32_t { /* j40.h:1873:20: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
func j40__64u32(tls *libc.TLS, st uintptr, o0 Int32_t, n0 Int32_t, o1 Int32_t, n1 Int32_t, o2 Int32_t, n2 Int32_t, o3 Int32_t, n3 Int32_t) Int64_t { /* j40.h:1889:20: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
func j40__u64(tls *libc.TLS, st uintptr) Uint64_t { /* j40.h:1905:21: */
...
func j40__enum(tls *libc.TLS, st uintptr) Int32_t { /* j40.h:1918:20: */
...
func j40__f16(tls *libc.TLS, st uintptr) float32 { /* j40.h:1926:18: */
	...
	return func() float32 {
		...
		return float32(1)
	}() * float32(math.Ldexp(float64(bits&0x3ff|func() int32 {
		if biased_exp > 0 {
			return 0x400
		}
		return 0
...
func j40__u8(tls *libc.TLS, st uintptr) Int32_t { /* j40.h:1946:20: */ // ANS distribution decoding only
...
func j40__at_most(tls *libc.TLS, st uintptr, max Int32_t) Int32_t { /* j40.h:1956:20: */
	var v Int32_t
	if max > 0 {
...
func j40__no_more_bytes(tls *libc.TLS, st uintptr) J40_err { /* j40.h:1963:29: */
__1:
...
func j40__prefix_code_tree(tls *libc.TLS, st uintptr, l2size Int32_t, out_fast_len uintptr, out_max_len uintptr, out_table uintptr) J40_err { /* j40.h:2001:29: */
	bp := tls.Alloc(456)
	defer tls.Free(456)
...
var L1ZIGZAG = [18]Uint8_t{Uint8_t(1), Uint8_t(2), Uint8_t(3), Uint8_t(4), Uint8_t(0), Uint8_t(5), Uint8_t(17), Uint8_t(6), Uint8_t(16), Uint8_t(7), Uint8_t(8), Uint8_t(9), Uint8_t(10), Uint8_t(11), Uint8_t(12), Uint8_t(13), Uint8_t(14), Uint8_t(15)} /* j40.h:2019:23 */
var TEMPLATES = [5]struct {
	...
	{Maxlen: int8(2), Sortto: int8(4), Len: [8]Int8_t{0: int8(2), 1: int8(2), 2: int8(2), 3: int8(2)}, Symref: [8]Int8_t{0: int8(0), 1: int8(1), 2: int8(2), 3: int8(3)}}}                    /* j40.h:2037:79 */

func j40__match_overflow(tls *libc.TLS, st uintptr, fast_len Int32_t, table uintptr) Int32_t { /* j40.h:2196:20: */
	var entry Int32_t
	var code Int32_t
...
func j40__prefix_code(tls *libc.TLS, st uintptr, fast_len Int32_t, max_len Int32_t, table uintptr) Int32_t { /* j40.h:2208:20: */
	var entry Int32_t
	var code_len Int32_t
...
func j40__read_hybrid_int_config(tls *libc.TLS, st uintptr, log_alpha_size Int32_t, out uintptr) J40_err { /* j40.h:2249:29: */
...
func j40__hybrid_int(tls *libc.TLS, st uintptr, token Int32_t, config J40__hybrid_int_config) Int32_t { /* j40.h:2265:20: */
	var midbits Int32_t
	var lo Int32_t
	var mid Int32_t
	var hi Int32_t
...
func j40__init_alias_map(tls *libc.TLS, st uintptr, D uintptr, log_alpha_size Int32_t, out uintptr) J40_err { /* j40.h:2314:29: */
...
func j40__ans_code(tls *libc.TLS, st uintptr, state uintptr, log_bucket_size Int32_t, D uintptr, aliases uintptr) Int32_t { /* j40.h:2393:20: */
...
func j40__cluster_map(tls *libc.TLS, st uintptr, num_dist Int32_t, max_allowed Int32_t, num_clusters uintptr, map1 uintptr) J40_err { /* j40.h:2477:29: */
	bp := tls.Alloc(384)
	defer tls.Free(384)
...
func j40__ans_table(tls *libc.TLS, st uintptr, log_alpha_size Int32_t, outtable uintptr) J40_err { /* j40.h:2542:29: */
	bp := tls.Alloc(1036)
	defer tls.Free(1036)
...
func j40__read_code_spec(tls *libc.TLS, st uintptr, num_dist Int32_t, spec uintptr) J40_err { /* j40.h:2651:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func j40__entropy_code_cluster(tls *libc.TLS, st uintptr, use_prefix_code int32, log_alpha_size Int32_t, cluster uintptr, ans_state uintptr) Int32_t { /* j40.h:2719:20: */
...
func j40__code(tls *libc.TLS, st uintptr, ctx Int32_t, dist_mult Int32_t, code uintptr) Int32_t { /* j40.h:2731:20: */
...
var MASK Int32_t = 0xfffff            /* j40.h:2732:23 */
...
func j40__free_code(tls *libc.TLS, code uintptr) { /* j40.h:2804:17: */
...
func j40__finish_and_free_code(tls *libc.TLS, st uintptr, code uintptr) J40_err { /* j40.h:2810:29: */
...
func j40__free_code_spec(tls *libc.TLS, spec uintptr) { /* j40.h:2825:17: */
	var i Int32_t
...
type J40__image_st = J40__image_st1 /* j40.h:2902:3 */

func j40__signature(tls *libc.TLS, st uintptr) J40_err { /* j40.h:2915:29: */
	var sig Int32_t
...
func j40__size_header(tls *libc.TLS, st uintptr, outw uintptr, outh uintptr) J40_err { /* j40.h:2922:29: */
	var div8 Int32_t
...
func j40__bit_depth(tls *libc.TLS, st uintptr, outbpp uintptr, outexpbits uintptr) J40_err { /* j40.h:2947:29: */ // float_sample
...
func j40__name(tls *libc.TLS, st uintptr, outlen uintptr, outbuf uintptr) J40_err { /* j40.h:2964:29: */
	var buf uintptr
	var i Int32_t
	var c Int32_t
	var cc Int32_t
...
func j40__customxy(tls *libc.TLS, st uintptr, xy uintptr) J40_err { /* j40.h:2996:29: */
...
func j40__extensions(tls *libc.TLS, st uintptr) J40_err { /* j40.h:3002:29: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func j40__image_metadata(tls *libc.TLS, st uintptr) J40_err { /* j40.h:3018:29: */
	var im uintptr
	var i Int32_t
	var j Int32_t
...
var E = [2]float32{float32(float32(1)) / 3., float32(float32(1)) / 3.}     /* j40.h:3141:25 */
var DCI = [2]float32{0.314, 0.351}                                         /* j40.h:3141:48 */
var BT2100 = [3][2]float32{{0.708, 0.292}, {0.170, 0.797}, {0.131, 0.046}} /* j40.h:3142:7 */
var P3 = [3][2]float32{{0.680, 0.320}, {0.265, 0.690}, {0.150, 0.060}}     /* j40.h:3143:7 */

func j40__free_image_state(tls *libc.TLS, im uintptr) { /* j40.h:3229:17: */
	var i Int32_t
...
func j40__icc(tls *libc.TLS, st uintptr) J40_err { /* j40.h:3250:29: */
	bp := tls.Alloc(96)
	defer tls.Free(96)
...
func j40__tree(tls *libc.TLS, st uintptr, max_tree_size Int32_t, tree uintptr, codespec uintptr) J40_err { /* j40.h:3348:29: */
	bp := tls.Alloc(52)
	defer tls.Free(52)
...
func j40__init_modular_common(tls *libc.TLS, m uintptr) { /* j40.h:3476:17: */
...
func j40__init_modular(tls *libc.TLS, st uintptr, num_channels Int32_t, w uintptr, h uintptr, m uintptr) J40_err { /* j40.h:3485:29: */
	var i Int32_t
...
func j40__init_modular_for_global(tls *libc.TLS, st uintptr, frame_is_modular int32, frame_do_ycbcr int32, frame_log_upsampling Int32_t, frame_ec_log_upsampling uintptr, frame_width Int32_t, frame_height Int32_t, m uintptr) J40_err { /* j40.h:3503:29: */
	var im uintptr
	var i Int32_t
...
func j40__init_modular_for_pass_group(tls *libc.TLS, st uintptr, num_gm_channels Int32_t, gw Int32_t, gh Int32_t, minshift Int32_t, maxshift Int32_t, gm uintptr, m uintptr) J40_err { /* j40.h:3540:29: */
	var i Int32_t
...
func j40__combine_modular_from_pass_group(tls *libc.TLS, num_gm_channels Int32_t, gy Int32_t, gx Int32_t, minshift Int32_t, maxshift Int32_t, gm uintptr, m uintptr) { /* j40.h:3572:17: */
	var gcidx Int32_t
	var cidx Int32_t
	var y Int32_t
	var gx0 Int32_t
...
func j40__modular_header(tls *libc.TLS, st uintptr, global_tree uintptr, global_codespec uintptr, m uintptr) J40_err { /* j40.h:3601:29: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
func j40__allocate_modular(tls *libc.TLS, st uintptr, m uintptr) J40_err { /* j40.h:3745:29: */
...
func j40__free_modular(tls *libc.TLS, m uintptr) { /* j40.h:3756:17: */
	var i Int32_t
...
func J40__init_neighbors16(tls *libc.TLS, plane uintptr, x Int32_t, y Int32_t) J40__neighbors16 { /* j40.h:3842:38: */
...
func j40__gradient32(tls *libc.TLS, w Int32_t, n Int32_t, nw Int32_t) Int32_t { /* j40.h:3869:23: */
	var lo Int32_t = J40__min32(tls, w, n)
	var hi Int32_t = J40__max32(tls, w, n)
	return J40__min32(tls, J40__max32(tls, lo, w+n-nw), hi)
}

func j40__init_wp32(tls *libc.TLS, st uintptr, params J40__wp_params, width Int32_t, wp uintptr) J40_err { /* j40.h:3874:29: */
	var i Int32_t
...
func j40__wp_before_predict_internal32(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, pw Int16_t, pn Int16_t, pnw Int16_t, pne Int16_t, pnn Int16_t) { /* j40.h:3887:17: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
var ZERO = [4]int32{0, 0, 0, 0} /* j40.h:3894:23 */

func j40__wp_before_predict32(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, p uintptr) { /* j40.h:3950:17: */
...
func j40__predict32(tls *libc.TLS, st uintptr, pred Int32_t, wp uintptr, p uintptr) Int32_t { /* j40.h:3956:23: */
	switch pred {
	case 0:
		return 0
	case 1:
...
// also works when wp is zero-initialized (in which case does nothing)
func j40__wp_after_predict32(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, val Int32_t) { /* j40.h:3979:17: */
...
// also works when wp is zero-initialized (in which case does nothing)
func j40__reset_wp32(tls *libc.TLS, wp uintptr) { /* j40.h:3990:17: */
	var i Int32_t
	if (*J40__wp32)(unsafe.Pointer(wp)).Errors != 0 {
...
func j40__free_wp32(tls *libc.TLS, wp uintptr) { /* j40.h:3997:17: */
...
func j40__modular_channel16(tls *libc.TLS, st uintptr, m uintptr, cidx Int32_t, sidx Int64_t) J40_err { /* j40.h:4003:29: */
	bp := tls.Alloc(80)
	defer tls.Free(80)
...
func J40__init_neighbors32(tls *libc.TLS, plane uintptr, x Int32_t, y Int32_t) J40__neighbors32 { /* j40.h:3842:38: */
...
func j40__gradient64(tls *libc.TLS, w Int64_t, n Int64_t, nw Int64_t) Int64_t { /* j40.h:3869:23: */
	var lo Int64_t = J40__min64(tls, w, n)
	var hi Int64_t = J40__max64(tls, w, n)
	return J40__min64(tls, J40__max64(tls, lo, w+n-nw), hi)
}

func j40__init_wp64(tls *libc.TLS, st uintptr, params J40__wp_params, width Int32_t, wp uintptr) J40_err { /* j40.h:3874:29: */
	var i Int32_t
...
// also works when wp is zero-initialized (in which case does nothing)
func j40__wp_before_predict_internal64(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, pw Int32_t, pn Int32_t, pnw Int32_t, pne Int32_t, pnn Int32_t) { /* j40.h:3887:17: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
var ZERO1 = [4]int64{int64(0), int64(0), int64(0), int64(0)} /* j40.h:3894:23 */

func j40__wp_before_predict64(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, p uintptr) { /* j40.h:3950:17: */
...
func j40__predict64(tls *libc.TLS, st uintptr, pred Int32_t, wp uintptr, p uintptr) Int64_t { /* j40.h:3956:23: */
	switch pred {
	case 0:
		return int64(0)
	case 1:
...
// also works when wp is zero-initialized (in which case does nothing)
func j40__wp_after_predict64(tls *libc.TLS, wp uintptr, x Int32_t, y Int32_t, val Int64_t) { /* j40.h:3979:17: */
...
// also works when wp is zero-initialized (in which case does nothing)
func j40__reset_wp64(tls *libc.TLS, wp uintptr) { /* j40.h:3990:17: */
	var i Int32_t
	if (*J40__wp64)(unsafe.Pointer(wp)).Errors != 0 {
...
func j40__free_wp64(tls *libc.TLS, wp uintptr) { /* j40.h:3997:17: */
...
func j40__modular_channel32(tls *libc.TLS, st uintptr, m uintptr, cidx Int32_t, sidx Int64_t) J40_err { /* j40.h:4003:29: */
	bp := tls.Alloc(128)
	defer tls.Free(128)
...
func j40__modular_channel(tls *libc.TLS, st uintptr, m uintptr, cidx Int32_t, sidx Int64_t) J40_err { /* j40.h:4132:29: */
...
func j40__inverse_rct16(tls *libc.TLS, m uintptr, tr uintptr) { /* j40.h:4192:17: */
	bp := tls.Alloc(72)
	defer tls.Free(72)
...
var PERMUTATIONS = [6][3]Uint8_t{{Uint8_t(0), Uint8_t(1), Uint8_t(2)}, {Uint8_t(1), Uint8_t(2), Uint8_t(0)}, {Uint8_t(2), Uint8_t(0), Uint8_t(1)}, {Uint8_t(0), Uint8_t(2), Uint8_t(1)}, {Uint8_t(1), Uint8_t(0), Uint8_t(2)}, {Uint8_t(2), Uint8_t(1), Uint8_t(0)}} /* j40.h:4197:23 */

func j40__inverse_palette16(tls *libc.TLS, st uintptr, m uintptr, tr uintptr) J40_err { /* j40.h:4268:29: */
	bp := tls.Alloc(80)
	defer tls.Free(80)
...
func j40__inverse_rct32(tls *libc.TLS, m uintptr, tr uintptr) { /* j40.h:4192:17: */
	bp := tls.Alloc(72)
	defer tls.Free(72)
...
var PERMUTATIONS1 = [6][3]Uint8_t{{Uint8_t(0), Uint8_t(1), Uint8_t(2)}, {Uint8_t(1), Uint8_t(2), Uint8_t(0)}, {Uint8_t(2), Uint8_t(0), Uint8_t(1)}, {Uint8_t(0), Uint8_t(2), Uint8_t(1)}, {Uint8_t(1), Uint8_t(0), Uint8_t(2)}, {Uint8_t(2), Uint8_t(1), Uint8_t(0)}} /* j40.h:4197:23 */

func j40__inverse_palette32(tls *libc.TLS, st uintptr, m uintptr, tr uintptr) J40_err { /* j40.h:4268:29: */
	bp := tls.Alloc(128)
	defer tls.Free(128)
...
func j40__inverse_transform(tls *libc.TLS, st uintptr, m uintptr) J40_err { /* j40.h:4365:29: */
	var i Int32_t
	var tr uintptr
	var tr1 uintptr
...
const ( /* j40.h:4412:1: */ // the number of params per channel follows:
...
func j40__read_dq_matrix(tls *libc.TLS, st uintptr, rows Int32_t, columns Int32_t, raw_sidx Int64_t, global_tree uintptr, global_codespec uintptr, dqmat uintptr) J40_err { /* j40.h:4552:29: */
	bp := tls.Alloc(184)
	defer tls.Free(184)
...
var HOW = [7]How{{}, {Requires8x8: int8(1), Nparams: int8(3), Nscaled: int8(3)}, {Requires8x8: int8(1), Nparams: int8(6), Nscaled: int8(6)}, {Requires8x8: int8(1), Nparams: int8(2), Nscaled: int8(2), Ndctparams: int8(1)}, {Requires8x8: int8(1), Nparams: int8(1), Ndctparams: int8(1)}, {Requires8x8: int8(1), Nparams: int8(9), Nscaled: int8(6), Ndctparams: int8(2)}, {Requires8x8: int8(1), Ndctparams: int8(1)}} /* j40.h:4607:5 */

// piecewise exponential interpolation where pos is in [0,1], mapping pos = k/(len-1) to bands[k]
func j40__interpolate(tls *libc.TLS, pos float32, c Int32_t, bands uintptr, len Int32_t) float32 { /* j40.h:4636:18: */
	...
	return a * float32(math.Pow(float64(b/a), float64(frac_idx)))
}

func j40__interpolation_bands(tls *libc.TLS, st uintptr, params uintptr, nparams Int32_t, out uintptr) J40_err { /* j40.h:4648:29: */
	var i Int32_t
	var c Int32_t
	var v float32
	c = 0
...
func j40__dct_quant_weights(tls *libc.TLS, rows Int32_t, columns Int32_t, bands uintptr, len Int32_t, out uintptr) { /* j40.h:4667:17: */
	...
	for c = 0; c < 3; c++ {
		for y = 0; y < rows; y++ {
			for x = 0; x < columns; x++ { // 1/(sqrt(2) + 1e-6)
				var d float32 = float32(math.Hypot(float64(x)*float64(inv_columns_m1), float64(y)*float64(inv_rows_m1)))
...
var INV_SQRT2 float32 = float32(1.0) / 1.414214562373095 /* j40.h:4674:23 */
...
func j40__load_dq_matrix(tls *libc.TLS, st uintptr, idx Int32_t, dqmat uintptr) J40_err { /* j40.h:4684:29: */
	bp := tls.Alloc(1264)
	defer tls.Free(1264)
...
func j40__free_dq_matrix(tls *libc.TLS, dqmat uintptr) { /* j40.h:4830:17: */
...
func j40__natural_order(tls *libc.TLS, st uintptr, log_rows Int32_t, log_columns Int32_t, out uintptr) J40_err { /* j40.h:4836:29: */
	var size Int32_t
...
type J40__frame_st = J40__frame_st1 /* j40.h:4976:3 */

func j40__free_frame_state(tls *libc.TLS, f uintptr) { /* j40.h:4982:17: */
	var i Int32_t
	var j Int32_t
	var k Int32_t
...
func j40__frame_header(tls *libc.TLS, st uintptr) J40_err { /* j40.h:5017:29: */
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
func j40__permutation(tls *libc.TLS, st uintptr, code uintptr, size Int32_t, skip Int32_t, out uintptr) J40_err { /* j40.h:5284:29: */
	var arr uintptr
	var i Int32_t
	var prev Int32_t
	var end Int32_t
...
func j40__apply_permutation(tls *libc.TLS, targetbuf uintptr, temp uintptr, elemsize Size_t, lehmer uintptr) { /* j40.h:5316:17: */
...
func j40__compare_section(tls *libc.TLS, a uintptr, b uintptr) int32 { /* j40.h:5330:16: */
	var aa uintptr = a
	var bb uintptr = b
...
func j40__read_toc(tls *libc.TLS, st uintptr, toc uintptr) J40_err { /* j40.h:5335:29: */
	bp := tls.Alloc(144)
	defer tls.Free(144)
...
func j40__free_toc(tls *libc.TLS, toc uintptr) { /* j40.h:5508:17: */
...
func J40__forward_dct_core(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t, half_forward_dct uintptr) { /* j40.h:5622:24: */
	var r1 Int32_t
	var r2 Int32_t
	var i Int32_t
...
func J40__inverse_dct_core(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t, half_inverse_dct uintptr) { /* j40.h:5660:24: */
	var r1 Int32_t
	var r2 Int32_t
	var i Int32_t
	var N Int32_t = int32(1) << t
...
func J40__dct2(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5701:24: */
	var r1 Int32_t
	var r2 Int32_t
	var stride Int32_t = rep1 * rep2
	_ = t
...
func J40__forward_dct4(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5711:24: */
	_ = t
...
func j40__forward_dct_recur(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5716:17: */
	if t < 4 {
...
func j40__forward_dct_recur_x8(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5725:17: */
	_ = rep2
	if t < 4 {
...
func j40__forward_dct_unscaled(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep Int32_t) { /* j40.h:5736:17: */
	if t <= 0 {
...
func J40__forward_dct_unscaled_view(tls *libc.TLS, outv uintptr, inv uintptr) { /* j40.h:5750:24: */
...
func J40__inverse_dct4(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5755:24: */
	_ = t
...
func j40__inverse_dct_recur(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5760:17: */
	if t < 4 {
...
func j40__inverse_dct_recur_x8(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep1 Int32_t, rep2 Int32_t) { /* j40.h:5769:17: */
	_ = rep2
	if t < 4 {
...
func j40__inverse_dct(tls *libc.TLS, out uintptr, in uintptr, t Int32_t, rep Int32_t) { /* j40.h:5779:17: */
	if t <= 0 {
		libc.Xmemcpy(tls, out, in, uint64(unsafe.Sizeof(float32(0)))*Size_t(rep))
	} else if rep%8 == 0 {
		if t == 1 {
...
func J40__inverse_dct_view(tls *libc.TLS, outv uintptr, inv uintptr) { /* j40.h:5793:24: */
	J40__adapt_view_f32(tls, outv, (*J40__view_f32)(unsafe.Pointer(inv)).Logw, (*J40__view_f32)(unsafe.Pointer(inv)).Logh)
...
func j40__forward_dct2d_scaled_for_llf(tls *libc.TLS, buf uintptr, scratch uintptr, log_rows Int32_t, log_columns Int32_t) { /* j40.h:5802:17: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
func j40__inverse_dct2d(tls *libc.TLS, buf uintptr, scratch uintptr, log_rows Int32_t, log_columns Int32_t) { /* j40.h:5830:17: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
func J40__aux_inverse_dct11(tls *libc.TLS, out uintptr, in uintptr, x Int32_t, y Int32_t, S2 Int32_t) { /* j40.h:5851:24: */
	var p Int32_t = y*8 + x
...
func j40__inverse_dct11(tls *libc.TLS, buf uintptr) { /* j40.h:5860:17: */
	bp := tls.Alloc(256)
	defer tls.Free(256)
...
func j40__inverse_dct22(tls *libc.TLS, buf uintptr) { /* j40.h:5873:17: */
	bp := tls.Alloc(256)
	defer tls.Free(256)
...
func j40__inverse_hornuss(tls *libc.TLS, buf uintptr) { /* j40.h:5904:17: */
	bp := tls.Alloc(272)
	defer tls.Free(272)
...
func j40__inverse_dct32(tls *libc.TLS, buf uintptr) { /* j40.h:5925:17: */
	bp := tls.Alloc(288)
	defer tls.Free(288)
...
func j40__inverse_dct23(tls *libc.TLS, buf uintptr) { /* j40.h:5945:17: */
	bp := tls.Alloc(288)
	defer tls.Free(288)
...
func j40__inverse_afv22(tls *libc.TLS, out uintptr, in uintptr) { /* j40.h:5965:17: */
	var i Int32_t
	var j Int32_t
	for i = 0; i < 16; i++ {
		var sum float32 = 0.0
...
func j40__inverse_afv(tls *libc.TLS, buf uintptr, flipx int32, flipy int32) { /* j40.h:6041:17: */
	bp := tls.Alloc(256)
	defer tls.Free(256)
...
var FLIP_FOR_AFV = [2][4]Int8_t{{int8(0), int8(1), int8(2), int8(3)}, {int8(7), int8(6), int8(5), int8(4)}} /* j40.h:6095:23 */

func j40__lf_global(tls *libc.TLS, st uintptr) J40_err { /* j40.h:6115:29: */
	var f uintptr
	var sidx Int32_t
	var i Int32_t
...
type J40__lf_group_st = J40__lf_group_st1 /* j40.h:6249:3 */
...
func j40__dequant_lf16(tls *libc.TLS, in uintptr, mult float32, out uintptr) { /* j40.h:6281:17: */
	var x Int32_t
	var y Int32_t
...
func j40__add_thresholds16(tls *libc.TLS, plane uintptr, in uintptr, lf_thr uintptr, nb_lf_thr Int32_t) { /* j40.h:6293:17: */
	var x Int32_t
	var y Int32_t
	var i Int32_t
...
// out(x, y) = in(x, y) * mult (after type conversion)
func j40__dequant_lf32(tls *libc.TLS, in uintptr, mult float32, out uintptr) { /* j40.h:6281:17: */
	var x Int32_t
	var y Int32_t
...
// plane(x, y) += # of lf_thr[i] s.t. in(x, y) > lf_thr[i]
func j40__add_thresholds32(tls *libc.TLS, plane uintptr, in uintptr, lf_thr uintptr, nb_lf_thr Int32_t) { /* j40.h:6293:17: */
	var x Int32_t
	var y Int32_t
	var i Int32_t
...
func J40__dequant_lf(tls *libc.TLS, in uintptr, mult float32, out uintptr) { /* j40.h:6324:24: */
...
func J40__add_thresholds(tls *libc.TLS, plane uintptr, in uintptr, lf_thr uintptr, nb_lf_thr Int32_t) { /* j40.h:6332:24: */
	switch int32((*J40__plane)(unsafe.Pointer(in)).Type) {
	case J40__PLANE_I16:
...
func j40__multiply_each_u8(tls *libc.TLS, plane uintptr, mult Int32_t) { /* j40.h:6342:17: */
	var x Int32_t
	var y Int32_t
...
func j40__smooth_lf(tls *libc.TLS, st uintptr, gg uintptr, lfquant uintptr) J40_err { /* j40.h:6351:29: */
	bp := tls.Alloc(136)
	defer tls.Free(136)
...
var W0 float32 = 0.05226273532324128 /* j40.h:6352:21 */
var W1 float32 = 0.20345139757231578 /* j40.h:6352:48 */
var W2 float32 = 0.0334829185968739  /* j40.h:6352:75 */

func j40__lf_quant(tls *libc.TLS, st uintptr, extra_prec Int32_t, m uintptr, gg uintptr, outlfquant uintptr) J40_err { /* j40.h:6403:29: */
	bp := tls.Alloc(120)
	defer tls.Free(120)
...
var YXB2XYB = [3]Int32_t{1, 0, 2} /* j40.h:6406:23 */

func j40__hf_metadata(tls *libc.TLS, st uintptr, nb_varblocks Int32_t, m uintptr, lfquant uintptr, gg uintptr) J40_err { /* j40.h:6444:29: */
	bp := tls.Alloc(4192)
	defer tls.Free(4192)
...
func j40__lf_group(tls *libc.TLS, st uintptr, gg uintptr) J40_err { /* j40.h:6581:29: */
	bp := tls.Alloc(264)
	defer tls.Free(264)
...
func j40__free_lf_group(tls *libc.TLS, gg uintptr) { /* j40.h:6651:17: */
	var i Int32_t
	for i = 0; i < 3; i++ {
...
func j40__hf_global(tls *libc.TLS, st uintptr) J40_err { /* j40.h:6678:29: */
	bp := tls.Alloc(96)
	defer tls.Free(96)
...
func j40__hf_coeffs(tls *libc.TLS, st uintptr, ctxoff Int32_t, pass Int32_t, gx_in_gg Int32_t, gy_in_gg Int32_t, gw Int32_t, gh Int32_t, gg uintptr) J40_err { /* j40.h:6744:29: */
	bp := tls.Alloc(40)
	defer tls.Free(40)
...
var YXB2XYB1 = [3]Int32_t{1, 0, 2}     /* j40.h:6787:25 */
...
func j40__pass_group(tls *libc.TLS, st uintptr, pass Int32_t, gx_in_gg Int32_t, gy_in_gg Int32_t, gw Int32_t, gh Int32_t, gidx Int64_t, gg uintptr) J40_err { /* j40.h:6860:29: */
	bp := tls.Alloc(160)
	defer tls.Free(160)
...
func j40__dequant_hf(tls *libc.TLS, st uintptr, gg uintptr) { /* j40.h:6906:17: */
	bp := tls.Alloc(12)
	defer tls.Free(12)
...
var QM_SCALE = [8]float32{1.5625, 1.25, 1.0, 0.8, 0.64, 0.512, 0.4096, 0.32768} /* j40.h:6908:21 */

func j40__combine_vardct_from_lf_group(tls *libc.TLS, st uintptr, gg uintptr) J40_err { /* j40.h:6952:29: */
	bp := tls.Alloc(96)
	defer tls.Free(96)
...
__83:
	...
	*(*float32)(unsafe.Pointer(bp + 72 + uintptr(c)*4)) = float32(math.Cbrt(*(*float64)(unsafe.Pointer(im + 184 + uintptr(c)*4))))
	goto __84
__84:
	c++
	goto __83
...
__103:
	...
	v = func() float32 {
		...
		return 1.055*float32(math.Pow(float64(v), float64(1.0)/2.4)) - 0.055
	}() // to sRGB
	// TODO overflow check
...
func j40__mirror1d(tls *libc.TLS, coord Int32_t, size Int32_t) Int32_t { /* j40.h:7181:20: */
	for 1 != 0 {
		if coord < 0 {
			coord = -coord - 1
		} else if coord >= size {
...
func j40__epf_distance(tls *libc.TLS, in uintptr, dx Int32_t, dy Int32_t, out uintptr) { /* j40.h:7191:17: */
...
var sJ40__SIGMA_THRESHOLD float32 = 0.3 /* j40.h:7223:20 */
...
func j40__epf_recip_sigmas(tls *libc.TLS, st uintptr, gg uintptr, out uintptr) J40_err { /* j40.h:7227:29: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
...
func j40__epf_step(tls *libc.TLS, st uintptr, channels uintptr, sigma_scale float32, recip_sigmas uintptr, nkernels Int32_t, kernels uintptr, distances uintptr, dist_uses_cross int32, gg uintptr) J40_err { /* j40.h:7282:29: */
	bp := tls.Alloc(188)
	defer tls.Free(188)

	var distance_rows uintptr // j40.h:7350:9: array of array of 3 array of 3 pointer to float
...
var NKERNELS int32 = 12 /* j40.h:7287:19 */
...
func j40__allocate_lf_groups(tls *libc.TLS, st uintptr, out uintptr) J40_err { /* j40.h:7512:29: */
	var f uintptr
	var ggs uintptr
	var ggsize Int32_t
	var gsize Int32_t
...
func j40__prepare_dq_matrices(tls *libc.TLS, st uintptr) J40_err { /* j40.h:7547:29: */
	var f uintptr
...
func j40__prepare_orders(tls *libc.TLS, st uintptr) J40_err { /* j40.h:7564:29: */
	bp := tls.Alloc(12)
	defer tls.Free(12)
...
func J40__group_info(tls *libc.TLS, f uintptr, gidx Int64_t) J40__group_info1 { /* j40.h:7587:42: */
...
func j40__init_section_state(tls *libc.TLS, stptr uintptr, sst uintptr, codeoff Int64_t, size Int32_t) J40_err { /* j40.h:7605:29: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
var BUFFER_INIT = J40__buffer_st{} /* j40.h:7608:30 */

func j40__finish_section_state(tls *libc.TLS, stptr uintptr, sst uintptr, err J40_err) J40_err { /* j40.h:7631:29: */
	var st uintptr
...
func j40__lf_global_in_section(tls *libc.TLS, st uintptr, toc uintptr) J40_err { /* j40.h:7665:29: */
	bp := tls.Alloc(192)
	defer tls.Free(192)
...
func j40__hf_global_in_section(tls *libc.TLS, st uintptr, toc uintptr) J40_err { /* j40.h:7675:29: */
	bp := tls.Alloc(192)
	defer tls.Free(192)
	*(*uintptr)(unsafe.Pointer(bp)) = st
...
func j40__lf_or_pass_group_in_section(tls *libc.TLS, st uintptr, toc uintptr, ggs uintptr) J40_err { /* j40.h:7689:29: */
	bp := tls.Alloc(192)
	defer tls.Free(192)
	*(*uintptr)(unsafe.Pointer(bp)) = st
...
func j40__combine_vardct(tls *libc.TLS, st uintptr, ggs uintptr) J40_err { /* j40.h:7715:29: */
	var f uintptr
	var i Int64_t
	f = (*J40__st)(unsafe.Pointer(st)).Frame
...
func j40__end_of_frame(tls *libc.TLS, st uintptr, toc uintptr) J40_err { /* j40.h:7737:29: */
	var codeoff Int64_t
__1:
	if !(libc.X__builtin_expect(tls, libc.BoolInt64(!!(j40__zero_pad_to_byte(tls, st) != 0)), int64(0)) != 0) {
		goto __4
...
func j40__render_to_u8x4_rgba(tls *libc.TLS, st uintptr, out uintptr) J40_err { /* j40.h:7763:29: */
	bp := tls.Alloc(88)
	defer tls.Free(88)
...
type J40__origin = uint32 /* j40.h:7848:3 */
...
type J40__inner = J40__inner1 /* j40.h:7912:3 */

func j40__set_alt_magic(tls *libc.TLS, err J40_err, saved_errno int32, origin J40__origin, image uintptr) J40_err { /* j40.h:7935:29: */
...
func j40__set_magic(tls *libc.TLS, inner uintptr, image uintptr) J40_err { /* j40.h:7948:29: */
...
func j40__check_image(tls *libc.TLS, image uintptr, neworigin J40__origin, outinner uintptr) J40_err { /* j40.h:7955:20: */
...
func j40__init_state(tls *libc.TLS, st uintptr, inner uintptr) { /* j40.h:7973:17: */
...
func j40__advance(tls *libc.TLS, inner uintptr, origin J40__origin) J40_err { /* j40.h:7998:29: */
	bp := tls.Alloc(104)
	defer tls.Free(104)
...
func j40__free_inner(tls *libc.TLS, inner uintptr) { /* j40.h:8073:17: */
	var i Int64_t
...
func J40_error(tls *libc.TLS, image uintptr) J40_err { /* j40.h:8096:17: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func J40_error_string(tls *libc.TLS, image uintptr) uintptr { /* j40.h:8102:20: */
	bp := tls.Alloc(96)
	defer tls.Free(96)
...
var static_errbuf [256]int8 /* j40.h:8103:14: */

func J40_from_memory(tls *libc.TLS, image uintptr, buf uintptr, size Size_t, freefunc J40_memory_free_func) J40_err { /* j40.h:8172:17: */
	bp := tls.Alloc(104)
	defer tls.Free(104)
...
var ORIGIN J40__origin = J40__ORIGIN_from_memory /* j40.h:8173:27 */

func J40_from_file(tls *libc.TLS, image uintptr, path uintptr) J40_err { /* j40.h:8193:17: */
	bp := tls.Alloc(104)
	defer tls.Free(104)
...
var ORIGIN1 J40__origin = J40__ORIGIN_from_file /* j40.h:8194:27 */

func J40_output_format(tls *libc.TLS, image uintptr, channel Int32_t, format Int32_t) J40_err { /* j40.h:8214:17: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
var ORIGIN2 J40__origin = J40__ORIGIN_output_format /* j40.h:8215:27 */

func J40_next_frame(tls *libc.TLS, image uintptr) int32 { /* j40.h:8228:13: */
	bp := tls.Alloc(112)
	defer tls.Free(112)
...
var ORIGIN3 J40__origin = J40__ORIGIN_next_frame /* j40.h:8229:27 */

func J40_current_frame(tls *libc.TLS, image uintptr) J40_frame { /* j40.h:8254:19: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
var ORIGIN4 J40__origin = J40__ORIGIN_current_frame /* j40.h:8255:27 */

func J40_frame_pixels_u8x4(tls *libc.TLS, frame uintptr, channel Int32_t) J40_pixels_u8x4 { /* j40.h:8276:25: */
	var inner uintptr
...
var ORIGIN5 J40__origin = J40__ORIGIN_frame_pixels /* j40.h:8277:27 */
...
var ERROR_PIXELS = J40_pixels_u8x4{Width: 21, Height: 7, Stride_bytes: 21 * 4, Data: 0} /* j40.h:8292:31 */

func J40_row_u8x4(tls *libc.TLS, pixels J40_pixels_u8x4, y Int32_t) uintptr { /* j40.h:8315:24: */

	return pixels.Data + uintptr(Size_t(pixels.Stride_bytes)*Size_t(y))
}

func J40_free(tls *libc.TLS, image uintptr) { /* j40.h:8322:14: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func init() {
	*(*uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&ERROR_PIXELS)) + 16 /* .data */)) = uintptr(unsafe.Pointer(&ERROR_PIXELS_DATA)) // j40.h:8292:62:
}
